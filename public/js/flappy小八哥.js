...
wing.img = loadGameImage('images/wing.png'); // 150 x 131
...
wingfill.img = loadGameImage('images/wingfill.png'); // 150 x 131
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('images/logo.png'); // 626 x 188
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('images/gameover.png'); // 626 x 144
...
fbshare.showing = false;
fbshare.hiding = true;
fbshare.img = loadGameImage('images/fbshare.png');
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('images/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('images/clicktostart.png'); // 337 x 75
...
ground.bit = loadGameImage('images/ground.png');
